...
(function(global, factory) {
    if (typeof module === 'object') {
        ...
        pathgen.generator = factory(window.umd_logger, window.MessageBus);
    }
})(this, function(console, MessageBus) {
    var _instance = null;
    var newInstance = function(engine, player, _defer) {
        var paths = [],
            // util = engine.scion,
            event,
            visited,
    ...
    return {
        init: function(engine, simulator, defer) {
            if (engine) {
                if (_instance) {
                    return _instance;
                } else {
                    _instance = newInstance(engine, simulator, defer);
